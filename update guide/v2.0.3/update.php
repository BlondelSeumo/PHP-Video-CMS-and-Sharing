            ...
            <div class="col-md-10">
               <div class="wo_install_wiz">
                 <?php if ($updated == false) { ?>
                  <div>
                     <h2 class="light">v2.0.3 <span style="color: red; font-size: 14px;">Important Update </span></h2>
                     <div class="setting-well">
                        <h4>Changelog</h4>
                        <ul class="wo_update_changelog">
                                <li>[Fixed] video privacy issue. </li>
                               <li>[Fixed] video image ads count down issue. </li>
                               <li>[Fixed] video cards issue on self hosted videos. </li>
...
<script>  
var queries = [
    "UPDATE `config` SET `value` = '2.0.3' WHERE `name` = 'version';",
];
